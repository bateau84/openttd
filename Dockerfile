...
WORKDIR /tmp/
RUN wget -q http://binaries.openttd.org/releases/1.5.0-beta2/openttd-1.5.0-beta2-linux-ubuntu-trusty-amd64.deb && dpkg -i /tmp/openttd-1.5.0-beta2-linux-ubuntu-trusty-amd64.deb
