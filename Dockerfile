...
WORKDIR /tmp/
RUN wget -q http://binaries.openttd.org/releases/1.4.2/openttd-1.4.2-linux-ubuntu-trusty-amd64.deb 

# Install openttd 
RUN dpkg -i /tmp/openttd-1.4.2-linux-ubuntu-trusty-amd64.deb
